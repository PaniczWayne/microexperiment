package org.xstream.microexperiment.recommendation.service;
...
public class RecommendationService {
    ...
    /**
     * Sample usage: $HOST:$PORT/recommendation?productId=1
     *
     * @param productId
     * @return
     */
    ...
    @RequestMapping("/")
    public String index() {
        return "{\"timestamp\":\"" + new Date() + "\",\"content\":\"Hello from RecommendationAPI\"}";
    }
